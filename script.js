...
let employee = [
    ...
    {name : "e",salary : 500000}
]

let newEmployee = employee.filter((c,i,t)=>{
...
let newEmp = employee.find((c,i,t)=>{
...
let dd = [343,2,66,890,12,1]

let sortVal1 = dd.sort((a1,b1)=>{
...
console.log(str.slice(2,5)); // si , ei+1
